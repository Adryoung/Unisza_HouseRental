<%-- 
    ...
    Created on : 27 Dec 2022, 12:59:54
    Author     : mella
--%>
    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
                ...
                <center>
                    <form method="post" class="login" action="owner.jsp" >
                        <%// untuk log in Owner
                        ...
                        <div class="login__field">
                            ...
                            <input type="text" name="name"  class="login__input">
                        </div>
                        ...
                        <div class="login__field">
                            <i class="login__icon fas fa-user"></i>
                            <input type="text" name="icOwner" id="icOwner" class="login__input">
                        </div>
                        ...
                        <div class="login__field">
                            ...
                            <input type="text" name="address" class="login__input">
                        </div>

                        <div class="login__field">
                            <i class="login__icon fas fa-phone"></i>
                            <input type="text" name="noTel" class="login__input">
                        </div>

                        <div class="login__field">
                            <i class="login__icon fas fa-lock"></i>
                            <input type="password" name="pass" class="login__input" >
                        </div>

                        <button class="button login__submit" name="update">
                            <span class="button__text">Update</span>
                        </button>

                        <button class="button login__submit" name="">
