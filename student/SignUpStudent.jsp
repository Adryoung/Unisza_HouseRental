<%-- 
    ...
    Created on : 13 Jan 2023, 17:23:19
    Author     : mella
--%>
        ...
        <div class="screen">
            <div class="screen__content">
                ...
                <form method="post" action="student.jsp" class="login">
                    <h2 align="center" style="margin-top:-3em;">Sign Up</h2>



                    <div class="login__field">
                        <i class="login__icon fas fa-user"></i>
                        <input type="text"  name="name" id="name" class="login__input" placeholder="Name" maxlength="50" required="">
                    </div>

                    <div class="login__field">
                        <i class="login__icon fas fa-user"></i>
                        <input type="number" name="noMatrik" id="noMatirk" class="login__input" placeholder="Matric Number" maxlength="15" required="">
                    </div>

                    <div class="login__field">
                        <i class="login__icon fas fa-user"></i>
                        <input type="number" name="icStudent" id="icStudent" class="login__input" placeholder="IC Number" maxlength="12" required="">
                    </div>


                    <div class="login__field">
                        <i class="login__icon fas fa-user"></i>
                        <input type="email" name="email" class="login__input" maxlength="100" placeholder="Email" required="">
                    </div>

                    <div class="login__field">
                        <i class="login__icon fas  fa-location-arrow"></i>
                        <input type="text" name="address" class="login__input" maxlength="100" placeholder="Address" required="">
                    </div>

                    <div class="login__field">
                        <i class="login__icon fas fa-phone"></i>
                        <input type="number" name="noTel" maxlength="12" class="login__input" placeholder="Phone Number" required="">
                    </div>

                    <div class="login__field">
                        <i class="login__icon fas fa-lock"></i>
                        <input type="password" name="pass" id="pass" class="login__input" minilength="12" maxlength="12"  placeholder="Password" required="">
                    </div>
                    ...
                    <button class="button login__submit" name="reset">
                            <span href="" class="button_text">Cancel</span>
                            <i class="button__icon fas fa-chevron-right"></i>
                        </button>
